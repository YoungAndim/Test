...
<%@include file="/WEB-INF/jsp/common/head.jsp"%>
 <div class="right">
        ...
        <div class="providerView">
            ...
            <p><strong>企业营业执照：</strong><span><img alt="企业营业执照" src="${pageContext.request.contextPath }/statics/uploadfiles/${provider.companyLicPicPath}"/></span></p>
            <p><strong>组织机构代码证：</strong><span><img alt="组织机构代码证" src="${pageContext.request.contextPath }/statics/uploadfiles/${provider.orgCodePicPath}"/></span></p>
