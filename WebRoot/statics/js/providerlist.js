...
$(function(){
	$(".viewProvider").on("click",function(){
		...
		var obj = $(this);
//		window.location.href=path+"/provider/view?method=view&proid="+ obj.attr("proid");
		window.location.href=path+"/provider/view/"+ obj.attr("proid");
	});
	
	$(".modifyProvider").on("click",function(){
		var obj = $(this);
//		window.location.href=path+"/provider/provider.do?method=modify&proid="+ obj.attr("proid");view2
		window.location.href=path+"/provider/view2/"+ obj.attr("proid");
	});
